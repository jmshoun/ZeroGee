...
class HUD(object):
    ...
    def draw(self):
        ...
        text.render_text(self.panel, self.primary_font, gate_text, (0.05, 0.12), size=2)
        text.render_text(self.panel, self.primary_font, "TIME:", (0.05, 0.25),
                         foreground=text.BLUE, size=1.2)
        text.render_text(self.panel, self.primary_font, time_text, (0.05, 0.32), size=2)
        text.render_text(self.panel, self.primary_font, "SPEED:", (0.05, 0.45),
                         foreground=text.BLUE, size=1.2)
        text.render_text(self.panel, self.primary_font, speed_text, (0.05, 0.52), size=2)
        text.render_text(self.panel, self.primary_font, "FUEL LEFT:", (0.05, 0.65),
                         foreground=text.BLUE, size=1.2)
        text.render_text(self.panel, self.primary_font, fuel_text, (0.05, 0.72), size=2)
